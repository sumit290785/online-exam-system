...
<table width="800" border="0" align="center" cellpadding="0" cellspacing="0">
  ...
  <tr>
    <td><table width="100%" border="0" cellspacing="0" cellpadding="0" class="USS2">
      <tr>
        <td width="8%" height="61" valign="top">&nbsp;一、</td>
        <td width="92%" valign="top"><p>各课程的复习、考试（包括考察）均应严格按照学校规定的日期、地点进行，不得擅自变动；如需变动必须事先征得教务处同意。</p></td>
      </tr>
      <tr>
      ...
      <tr>
        <td height="107" valign="top">&nbsp;十一、</td>
        <td valign="top">考试时，学生不得交头接耳，不准抄袭，不准互递纸条，严禁暗中夹带与考试有关的纸条、笔记等。如有上述行为者，视为作弊。第一次作弊给予留校察看处分；重犯者，予以退学；由他人代替考试或替他人参加考试、组织作弊、使用通讯设备作弊及其他严重作弊行为者，予以开除学籍处分；替考未遂者，给予留校察看处分。</td>
      </tr>
      <tr>
        <td height="157" valign="top">&nbsp;十二、</td>
        <td valign="top">监考教师应严守职责，不得迟到、早退，中途不得擅离监考岗位。考试前十分钟到达试场并作好试场的检查清理工作，发现问题应及时处理。如遇试场安排不当，或因设备等原因影响考试准时进行，监考人员应立即与有关部门联系采取措施解决，所延误的考试时间，允许补足，对失职人员要查究责任。监考时，要集中精力，认真负责，不得做与监考无关的事情。发现问题应及时报告主考，并妥善作出处理。考试结束时，须认真填写考场情况记录表并及时上报教务处。凡监考失职，将根据情况，给予批评教育直至处分。</td>
      </tr>
      <tr>
        <td height="133" valign="top">&nbsp;十三、</td>
        <td valign="top">学生应独立完成答卷，监考人员发现违纪作弊者（包括协同作弊者），处理要慎重，首先要及时报告主考，掌握确凿证据，应当众宣布取消其考试资格，没收其试卷，令其退出试场。该课程成绩以零分计，不准参加正常补考。并根据其违纪程度，酌情给予相应的处分。考试结束后，主考和监考人员须及时将违纪作弊者（包括协同作弊者）详细情况的书面报告连同证据交教务处处理。</td>
      </tr>
      <tr>
        <td height="63" valign="top">&nbsp;十四、</td>
        <td valign="top">因考试违纪未获得该课程成绩的学生，如以后确有悔改表现，由本人申请，经院（系）领导审核同意，报教务处批准，毕业前可给予一次补考的机会。</td>
      </tr>
      <tr>
        <td valign="top">&nbsp;十五、</td>
        <td valign="top">考试结束后，各院（系）、部要及时组织教师阅卷，评分标准要统一，做到公平、公正。试卷要有专人负责保管，以备查阅，试卷的保存期为三学年。</td>
      </tr>
    </table></td>
  </tr>
</table>
